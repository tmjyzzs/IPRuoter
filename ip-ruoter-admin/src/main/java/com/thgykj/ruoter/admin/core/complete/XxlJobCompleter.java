package com.thgykj.ruoter.admin.core.complete;
            ...
            if (xxlJobInfo!=null && xxlJobInfo.getChildJobId()!=null && xxlJobInfo.getChildJobId().trim().length()>0) {
                ...
                for (int i = 0; i < childJobIds.length; i++) {
                    ...
                    if (childJobId > 0) {
                        ...
                        // add msg
                        triggerChildMsg += MessageFormat.format("jobconf_callback_child_msg1",
                                (i+1),
                                childJobIds.length,
                                childJobIds[i],
                        ...
                        triggerChildMsg += MessageFormat.format("jobconf_callback_child_msg2",
                                (i+1),
                                childJobIds.length,
                                childJobIds[i]);
                    }
